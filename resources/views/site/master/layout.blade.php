    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <a class="nav-link active" aria-current="page" href="{{ route('site.home') }}">Home</a></li>
            <a class="nav-link" href="{{ route('site.service') }}">Serviços</a></li>
            <a class="nav-link" href="{{ route('site.contact') }}">Contatos</a></li>
